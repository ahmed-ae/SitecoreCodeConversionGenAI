...
const Stream = () => {
  ...
  const handleConvertFigma = async (e: React.FormEvent<Element>) => {
    e.preventDefault();
    ...
    //   const base64Files = await convertToBase64(file);
      ...
      posthog.capture("Converting Figma", { userId: session?.user?.email });
        ...
        <div className="container mx-auto py-6 sm:py-12 px-4 max-w-full w-full sm:w-[95%]">
          <div className="bg-gray-800 rounded-xl p-4 sm:p-6 shadow-2xl border border-gray-700">
            <ControlPanel
              ...
              onConvertClick={handleConvertFigma}
              onStopClick={stop}
              isLoading={isLoading}
            />
